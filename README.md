...
A local, privacy-first AI intelligence platform that aggregates content from Hacker News and RSS feeds, evaluates it using a local LLM (Llama 3), and delivers a personalized digest via Email.
